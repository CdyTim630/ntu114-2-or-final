...
% allow more floats per page so Table 1 + Fig 2 + Fig 3 can share a page
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.36\textwidth]{../results/figs/fig_feasibility.png}
...
\bibitem{mifflin} M. D. Mifflin et al., ``A new predictive equation for resting energy expenditure in healthy individuals,'' \textit{American Journal of Clinical Nutrition}, 1990.
\bibitem{feo1995} T. A. Feo and M. G. C. Resende, ``Greedy randomized adaptive search procedures,'' \textit{Journal of Global Optimization}, 1995.
\bibitem{gurobi} Gurobi Optimization, LLC, \textit{Gurobi Optimizer Reference Manual}, \url{https://www.gurobi.com/documentation/}.
\bibitem{familymart} FamilyMart, Food Safety Traceability API, \url{foodsafety.family.com.tw/Web_FFD_2022/ws/QueryFsProductListByFilter}, and Fresh Food Promotion Pages, \url{https://nevent.family.com.tw/freshfood/}, accessed 2026.
\end{thebibliography}
