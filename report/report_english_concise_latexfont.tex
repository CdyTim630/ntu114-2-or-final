...
\noindent [1] M. D. Mifflin et al., ``A new predictive equation for resting energy expenditure in healthy individuals,'' \textit{American Journal of Clinical Nutrition}, 1990.\par
\noindent [2] T. A. Feo and M. G. C. Resende, ``Greedy randomized adaptive search procedures,'' \textit{Journal of Global Optimization}, 1995.\par
\noindent [3] Gurobi Optimization, LLC, \textit{Gurobi Optimizer Reference Manual}, \url{https://www.gurobi.com/documentation/}.\par
\noindent [4] FamilyMart, Food Safety Traceability API, \url{foodsafety.family.com.tw/Web_FFD_2022/ws/QueryFsProductListByFilter}, and Fresh Food Promotion Pages, \url{https://nevent.family.com.tw/freshfood/}, accessed 2026.\par
}
